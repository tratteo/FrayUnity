...
namespace Pathfinding
{
    ...
    public static class AstarUpdateChecker
    {
        ...
        /// <summary>
        ///   Holds various URLs and text for the editor. This info can be updated when a check for new versions is done to ensure that
        ///   there are no invalid links.
        /// </summary>
        ...
        /// <summary>
        ///   Checking for updates... Should be called from EditorApplication.update
        /// </summary>
        ...
        /// <summary>
        ///   Checks for updates if there was some time since last check. It must be called repeatedly to ensure that the result is processed.
        ...
        private static bool CheckForUpdates()
        {
            ...
            // Check if it is time to check for updates Check for updates a bit earlier if we are in play mode or have the AstarPath object
            // in the scene as then the collected statistics will be a bit more accurate
